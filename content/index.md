...
**ML:**
PyTorch, TensorFlow, Keras, Scikit-learn, XGBoost, LightGBM, MLFlow, SHAP, Captum, Accelerate

**Generative AI:**
LangChain, LangGraph, LlamaIndex, Nano-GraphRAG, Qdrant, ChromaDB, Ollama, Chainlit, AutoResearch, Coding CLIs (Codex, Claude Code, OpenCode)

**Languages & Backend:**
Python, C/C++, SQL, JavaScript, FastAPI, Flask, PostgreSQL, MongoDB

**Cloud & DevOps:**
AWS, Docker, Kubernetes, Terraform, Git, Linux, ArgoCD, Travis CI, Postman
